...
QString FileLogger::getCurrentLogFilename() const
{
    ...
    if(Application::instance())
        baseFilename = Application::instance()->getUniqueApplicationName();

    QDir dir(this->dirPath);
    QStringList logFiles = dir.entryList(QStringList(this->getLogFilenameFormat(baseFilename, '*')), QDir::Filter::Files);
    ...
    QFile currentFile(dir.filePath(this->getLogFilenameFormat(baseFilename, currentLogFileNum)));
